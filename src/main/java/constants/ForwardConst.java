...
public enum ForwardConst {
    ...
    //action
    ACT("action"), ACT_TOP("Top"), ACT_EMP("Employee"), ACT_REP("Report"), ACT_LIK("Like"), ACT_AUTH("Auth"),

    //command
    CMD("command"), CMD_NONE(""), CMD_INDEX("index"), CMD_SHOW("show"), CMD_SHOW_LOGIN("showLogin"), CMD_LOGIN(
            "login"), CMD_LOGOUT("logout"), CMD_NEW("entryNew"), CMD_CREATE("create"), CMD_EDIT(
                    "edit"), CMD_UPDATE("update"), CMD_DESTROY("destroy"), CMD_LIKECOUNT("likeCount"),
